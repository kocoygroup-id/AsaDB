...
for required in \
  ...
  src/asadb_core.pl src/asadb_sql_frontend.pl src/asadb_prolog_jit.pl src/asadb_backup.pl src/asadb_interchange.pl src/asadb_pager.pl src/bridge/karyawan.pl src/bridge/reservoir.pl src/bridge/horsemen/contract/war/here/yoru_the_wardevil.pl web/index.html web/assets/app.js \
