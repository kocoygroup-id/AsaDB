...
for required in \
  ...
  src/asadb.pl src/asadb_web.pl src/asadb_backup.pl src/asadb_interchange.pl src/asadb_pager.pl src/asadb_sql_frontend.pl src/asadb_prolog_jit.pl src/bridge/reservoir.pl tests/reservoir_large_sql_regression.sh tests/reservoir_unique_cache_regression.sh \
